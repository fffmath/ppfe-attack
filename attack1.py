...
def generate_RSA_instance(known_bit_length, modulus_bit_length, delta, seed=None, max_attempts=10):
    ...
    while attempts < max_attempts:
        ...
        if N.nbits() != modulus_bit_length and d.nbits() != d_bit_length:
            ...
            logging.info(f"Generated RSA instance with N = {N}, e = {e}")
            logging.info(f"Generated RSA instance with known_bit_length = {known_bit_length}")
            logging.info(f"Generated RSA instance with p = {p}")
            logging.info(f"Generated RSA instance with q = {q}")
            logging.info(f"Generated RSA instance with p0 = {p0}")
            logging.info(f"Generated RSA instance with q0 = {q0}")
            logging.info(f"Generated RSA instance with root = {(1-e*d)/((p**2-1)*(q**2-1)), p+q-p0-q0}")
            return N, e, p0, q0
...
def attack_RSA_instance(known_bit_length,modulus_bit_length, m, delta, seed=None, max_attempts=10):
    ...
    """
    N, e ,p0, q0 = generate_RSA_instance(known_bit_length,modulus_bit_length, delta, seed=seed, max_attempts=10)
...
def attack1(test_times, known_bit_length, modulus_bit_length, m, delta, seed=None, max_attempts=10):
    """
    Attack an RSA instance with given bit-lengths of the modulus and private key d
    :param test_times: the number of times to test the attack
    :param modulus_bit_length: the bit length of the modulus
    :param m: a given parameter for controlling the lattice dimension
    :param delta: a given size on the private exponent (d is roughly N^delta)
    :param seed: the seed for the random number generator
...
test_times = 1
m = 3
seed= 1713092613358825
attack1(test_times, known_bit_length, modulus_bit_length, m, delta, seed=seed, max_attempts=10)

'''
 - INFO - Succeeded!
 - INFO - Found p = 67881471738690473787861841070701758280146126555762125847941714881768729278103
 - INFO - Found q = 87427506231833777079631956919413869620641498219413367045946587075282557814679
 - INFO - Test 1 costs 6.113005 seconds
 - INFO - The success rate for delta=0.484 using m=3 is 100.0% and average time is 6.113005 seconds
'''